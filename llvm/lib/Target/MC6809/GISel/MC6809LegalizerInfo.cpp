...
bool MC6809LegalizerInfo::legalizeCustom(LegalizerHelper &Helper,
                                      MachineInstr &MI) const {
  LLVM_DEBUG(dbgs() << "OINQUE DEBUG " << __FILE__ << " : " << __func__ << " : Enter\n";);
...
bool MC6809LegalizerInfo::legalizeConstant(LegalizerHelper &Helper,
...
bool MC6809LegalizerInfo::legalizeSExt(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  LLT S1 = LLT::scalar(1);
  LLT S8 = LLT::scalar(8);
...
bool MC6809LegalizerInfo::legalizeZExt(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  Register Dst = MI.getOperand(0).getReg();
...
bool MC6809LegalizerInfo::legalizeBSwap(LegalizerHelper &Helper,
                                     MachineRegisterInfo &MRI,
                                     MachineInstr &MI) const {
  LLT S8 = LLT::scalar(8);
...
bool MC6809LegalizerInfo::legalizeAddSub(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::legalizeXor(LegalizerHelper &Helper,
                                   MachineRegisterInfo &MRI,
                                   MachineInstr &MI) const {
  LLT S1 = LLT::scalar(1);
  ...
  if (mi_match(Dst, MRI, m_Not(m_Reg(Not)))) {
    ...
    for (MachineInstr &UseMI : MRI.use_nodbg_instructions(Dst)) {
      if (UseMI.getOpcode() == MC6809::G_BRCOND_IMM) {
      ...
      } else if (UseMI.getOpcode() == MC6809::G_SELECT &&
        ...
        UseMI.setDesc(Helper.MIRBuilder.getTII().get(MC6809::COPY));
        Helper.Observer.changedInstr(UseMI);
      }
    }
...
bool MC6809LegalizerInfo::legalizeDivRem(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::legalizeShiftRotate(LegalizerHelper &Helper,
                                           MachineRegisterInfo &MRI,
                                           MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  ...
  if (Amt >= 8) {
    ...
    case G_ROTR: {
      ...
      CarryIn = Builder
                    .buildInstr(MC6809::G_LSHRE, {S8, S1},
...
bool MC6809LegalizerInfo::legalizeLshrEShlE(LegalizerHelper &Helper,
                                         MachineRegisterInfo &MRI,
                                         MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  LLT S1 = LLT::scalar(1);
...
bool MC6809LegalizerInfo::shiftLibcall(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::legalizeICmp(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  ...
  if (Type != S8) {
    ...
    for (const auto &I : zip(LHSUnmergeDefs.Lows, RHSUnmergeDefs.Lows)) {
      auto Sbc = Builder.buildInstr(MC6809::G_SBC, {S8, S1, S1, S1, S1},
  ...
  case CmpInst::ICMP_EQ: {
    auto Sbc =
        Builder.buildInstr(MC6809::G_SBC, {S8, S1, S1, S1, S1}, {LHS, RHS, CIn});
  ...
  case CmpInst::ICMP_SLT: {
    ...
    if (RHSIsZero) {
      ...
      auto One = Builder.buildConstant(S1, 1);
      Builder.buildInstr(
          MC6809::G_SBC, {S8, S1, Dst /*=N*/, S1, S1},
...
bool MC6809LegalizerInfo::legalizeSelect(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::legalizeAbs(LegalizerHelper &Helper,
                                   MachineRegisterInfo &MRI,
                                   MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::legalizePtrAdd(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::legalizeAddSubO(LegalizerHelper &Helper,
                                       MachineRegisterInfo &MRI,
                                       MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  LLT S1 = LLT::scalar(1);
...
bool MC6809LegalizerInfo::legalizeSubE(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  LLT S1 = LLT::scalar(1);
  ...
  if (MI.getOpcode() == MC6809::G_USUBE) {
    auto Sbc =
        Builder.buildInstr(MC6809::G_SBC, {S8, S1, S1, S1, S1},
    ...
    assert(MI.getOpcode() == MC6809::G_SSUBE);
    auto Sbc =
        Builder.buildInstr(MC6809::G_SBC, {S8, S1, S1, S1, S1},
                           {MI.getOperand(2), MI.getOperand(3), CarryIn});
    Builder.setInsertPt(Builder.getMBB(), std::next(Builder.getInsertPt()));
...
bool MC6809LegalizerInfo::legalizeLoad(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  ...
  Helper.Observer.changingInstr(MI);
  MI.setDesc(Builder.getTII().get(MC6809::G_LOAD));
  MI.getOperand(0).setReg(Tmp);
  Helper.Observer.changedInstr(MI);
  return true;
}
...
// narrowed to 8 bits.
bool MC6809LegalizerInfo::legalizeStore(LegalizerHelper &Helper,
                                     MachineRegisterInfo &MRI,
                                     MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::selectAddressingMode(LegalizerHelper &Helper,
                                            MachineRegisterInfo &MRI,
                                            MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::tryAbsoluteAddressing(LegalizerHelper &Helper,
                                             MachineRegisterInfo &MRI,
                                             MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::tryAbsoluteIndexedAddressing(LegalizerHelper &Helper,
                                                    MachineRegisterInfo &MRI,
                                                    MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  ...
  unsigned Opcode = IsLoad ? MC6809::G_LOAD_ABS_IDX : MC6809::G_STORE_ABS_IDX;
...
bool MC6809LegalizerInfo::selectIndirectIndexedAddressing(LegalizerHelper &Helper,
                                                       MachineRegisterInfo &MRI,
                                                       MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  ...
  unsigned Opcode = IsLoad ? MC6809::G_LOAD_INDIR_IDX : MC6809::G_STORE_INDIR_IDX;
...
bool MC6809LegalizerInfo::legalizePhi(LegalizerHelper &Helper,
                                   MachineRegisterInfo &MRI,
                                   MachineInstr &MI) const {
  LLT S16 = LLT::scalar(16);
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::legalizeBrCond(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
...
bool MC6809LegalizerInfo::legalizeBrJt(LegalizerHelper &Helper,
                                    MachineRegisterInfo &MRI,
                                    MachineInstr &MI) const {
  LLT S8 = LLT::scalar(8);
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  ...
  Builder.buildInstr(MC6809::G_LOAD_ABS_IDX)
      .addDef(LoAddr)
      .add(MI.getOperand(1))
      .addUse(Offset);
  ...
  Builder.buildInstr(MC6809::G_LOAD_ABS_IDX)
      .addDef(HiAddr)
      .addJumpTableIndex(MI.getOperand(1).getIndex(), MC6809::MO_HI_JT)
      .addUse(Offset);
...
bool MC6809LegalizerInfo::legalizeVAArg(LegalizerHelper &Helper,
                                     MachineRegisterInfo &MRI,
                                     MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
...
bool MC6809LegalizerInfo::legalizeVAStart(LegalizerHelper &Helper,
                                       MachineRegisterInfo &MRI,
                                       MachineInstr &MI) const {
  LLT P = LLT::pointer(0, 16);
...
bool MC6809LegalizerInfo::legalizeDynStackAlloc(LegalizerHelper &Helper,
                                             MachineRegisterInfo &MRI,
                                             MachineInstr &MI) const {
  MachineIRBuilder &Builder = Helper.MIRBuilder;
  Register Dst = MI.getOperand(0).getReg();
  ...
  auto SPTmp = Builder.buildCopy(PtrTy, Register(MC6809::SS));
  ...
  Builder.buildCopy(MC6809::SS, SPTmp);
...
bool MC6809LegalizerInfo::legalizeFreeze(LegalizerHelper &Helper,
                                      MachineRegisterInfo &MRI,
                                      MachineInstr &MI) const {
