...
inline static MC6809CC::CondCode getSwappedCondition(MC6809CC::CondCode CC) {
  switch (CC) {
  default: return MC6809CC::RA;
  case MC6809CC::EQ: return MC6809CC::EQ;
  case MC6809CC::NE: return MC6809CC::NE;
  case MC6809CC::HS: return MC6809CC::LS;
  case MC6809CC::LO: return MC6809CC::HI;
  case MC6809CC::HI: return MC6809CC::LO;
  case MC6809CC::LS: return MC6809CC::HS;
  case MC6809CC::GE: return MC6809CC::LE;
  case MC6809CC::LT: return MC6809CC::GT;
  case MC6809CC::GT: return MC6809CC::LT;
  case MC6809CC::LE: return MC6809CC::GE;
  }
}
