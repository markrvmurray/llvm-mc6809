...
// hosts five independently-gated late-stage transforms:
//
...
//
// Each class has its own minimum -O level (default >= -O2) and its own
// STATISTIC counter so we can see which classes fire on which workloads.
//
//===----------------------------------------------------------------------===//
