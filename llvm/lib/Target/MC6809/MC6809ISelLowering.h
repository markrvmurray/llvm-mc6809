...
public:
  ...
  bool isSelectSupported(SelectSupportKind /*kind*/) const override { return false; }
  ...
  MVT getRegisterTypeForCallingConv(LLVMContext &Context, CallingConv::ID CC, EVT VT, const ISD::ArgFlagsTy &Flags) const override;

  unsigned getNumRegistersForCallingConv(LLVMContext &Context, CallingConv::ID CC, EVT VT, const ISD::ArgFlagsTy &Flags) const override;
  ...
  LLT getOptimalMemOpLLT(const MemOp &Op, const AttributeList &FuncAttributes) const override { return LLT::scalar(8); }
