//===-- MC6809ShiftRotateChain.cpp - MC6809 Shift/Rotate Chaining ---------===//
//
...
//===----------------------------------------------------------------------===//
//
/// \file This file defines the MC6809 shift/rotate chaining pass.
...
#define DEBUG_TYPE "mc6809-shift-rotate-chain"

using namespace llvm;

namespace {

class MC6809ShiftRotateChain : public MachineFunctionPass {
public:
  static char ID;
