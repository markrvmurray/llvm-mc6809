...
public:
  ...
  const MC6809FrameLowering *getFrameLowering() const override { return &FrameLowering; }
  ...
  const MC6809TargetLowering *getTargetLowering() const override { return &TLInfo; }
  ...
  const RegisterBankInfo *getRegBankInfo() const override { return &RegBankInfo; }

  InstructionSelector *getInstructionSelector() const override { return InstSelector.get(); }

  const MC6809InlineAsmLowering *getInlineAsmLowering() const override { return &InlineAsmLoweringInfo; }

  uint16_t getDirectPageOffset() const { return 0; }
...
private:
  ...
  MC6809InlineAsmLowering InlineAsmLoweringInfo;
};
