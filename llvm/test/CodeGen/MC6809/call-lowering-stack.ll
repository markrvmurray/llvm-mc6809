...
define i16 @args_i16(i16 %w0, i16 %w1, i16 %w2, i16 %w3,
  ...
  ; CHECK-MC6809-NEXT:   RTSr implicit $ad
  ;
  ; CHECK-HD6309-LABEL: name: args_i16
  ; CHECK-HD6309: bb.1 (%ir-block.0):
  ; CHECK-HD6309-NEXT:   liveins: $ad
  ; CHECK-HD6309-NEXT: {{  $}}
  ...
  ; CHECK-HD6309-NEXT:   RTSr implicit $ad
...
define i8* @args_ptrs(i8* %x0, i16* %x1, <2 x i8>* %x2, {i8, i16, i16}* %x3,
  ...
  ; CHECK-MC6809: bb.1 (%ir-block.0):
  ; CHECK-MC6809-NEXT:   liveins: $ad, $ix
  ; CHECK-MC6809-NEXT: {{  $}}
  ; CHECK-MC6809-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $ix
  ; CHECK-MC6809-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $ad
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.5
  ; CHECK-MC6809-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.5, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.4
  ; CHECK-MC6809-NEXT:   [[LOAD1:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (p0) from %fixed-stack.4, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX2:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
  ; CHECK-MC6809-NEXT:   [[LOAD2:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX2]](p0) :: (invariant load (p0) from %fixed-stack.3, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; CHECK-MC6809-NEXT:   [[LOAD3:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX3]](p0) :: (invariant load (p0) from %fixed-stack.2, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; CHECK-MC6809-NEXT:   [[LOAD4:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX4]](p0) :: (invariant load (p0) from %fixed-stack.1, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; CHECK-MC6809-NEXT:   [[LOAD5:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX5]](p0) :: (invariant load (p0) from %fixed-stack.0, align 1)
  ; CHECK-MC6809-NEXT:   $ix = COPY [[COPY]](p0)
  ; CHECK-MC6809-NEXT:   RTSr implicit $ix
  ;
  ; CHECK-HD6309-LABEL: name: args_ptrs
  ; CHECK-HD6309: bb.1 (%ir-block.0):
  ; CHECK-HD6309-NEXT:   liveins: $ad, $ix
  ; CHECK-HD6309-NEXT: {{  $}}
  ; CHECK-HD6309-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $ix
  ; CHECK-HD6309-NEXT:   [[COPY1:%[0-9]+]]:_(p0) = COPY $ad
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.5
  ; CHECK-HD6309-NEXT:   [[LOAD:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (p0) from %fixed-stack.5, align 1)
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX1:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.4
  ; CHECK-HD6309-NEXT:   [[LOAD1:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX1]](p0) :: (invariant load (p0) from %fixed-stack.4, align 1)
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX2:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
  ; CHECK-HD6309-NEXT:   [[LOAD2:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX2]](p0) :: (invariant load (p0) from %fixed-stack.3, align 1)
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; CHECK-HD6309-NEXT:   [[LOAD3:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX3]](p0) :: (invariant load (p0) from %fixed-stack.2, align 1)
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; CHECK-HD6309-NEXT:   [[LOAD4:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX4]](p0) :: (invariant load (p0) from %fixed-stack.1, align 1)
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; CHECK-HD6309-NEXT:   [[LOAD5:%[0-9]+]]:_(p0) = G_LOAD [[FRAME_INDEX5]](p0) :: (invariant load (p0) from %fixed-stack.0, align 1)
...
define [1 x double] @args_arr([1 x double] %d0) {
  ...
  ; CHECK-MC6809-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[COPY]](s16), [[LOAD]](s16), [[LOAD1]](s16), [[LOAD2]](s16)
  ; CHECK-MC6809-NEXT:   [[UV:%[0-9]+]]:_(s16), [[UV1:%[0-9]+]]:_(s16), [[UV2:%[0-9]+]]:_(s16), [[UV3:%[0-9]+]]:_(s16) = G_UNMERGE_VALUES [[MV]](s64)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX3:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.2
  ; CHECK-MC6809-NEXT:   G_STORE [[UV1]](s16), [[FRAME_INDEX3]](p0) :: (store (s16) into %fixed-stack.2, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX4:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.1
  ; CHECK-MC6809-NEXT:   G_STORE [[UV2]](s16), [[FRAME_INDEX4]](p0) :: (store (s16) into %fixed-stack.1, align 1)
  ; CHECK-MC6809-NEXT:   [[FRAME_INDEX5:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.0
  ; CHECK-MC6809-NEXT:   G_STORE [[UV3]](s16), [[FRAME_INDEX5]](p0) :: (store (s16) into %fixed-stack.0, align 1)
  ...
  ; CHECK-HD6309-NEXT:   G_STORE [[UV1]](s32), [[FRAME_INDEX1]](p0) :: (store (s32) into %fixed-stack.0, align 1)
...
define void @test_varargs() {
  ...
  ; CHECK-MC6809-NEXT:   BranchSubroutine @varargs, mc6809_csr
  ...
  ; CHECK-HD6309-NEXT:   BranchSubroutine @varargs, mc6809_csr
...
define void @test_stack_ext_needed() {
  ...
  ; CHECK-MC6809-NEXT:   BranchSubroutine @stack_ext_needed, mc6809_csr, implicit $ab
  ...
  ; CHECK-HD6309-NEXT:   BranchSubroutine @stack_ext_needed, mc6809_csr, implicit $ab
...
define i8 @i8i16caller() nounwind readnone {
  ...
  ; CHECK-MC6809-NEXT:   ADJCALLSTACKDOWN 13, 0, implicit-def $ss, implicit $ss
  ; CHECK-MC6809-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $ss
  ...
  ; CHECK-MC6809-NEXT:   G_STORE [[C4]](s16), [[PTR_ADD3]](p0) :: (store (s16) into stack + 3, align 1)
  ; CHECK-MC6809-NEXT:   [[C16:%[0-9]+]]:_(s16) = G_CONSTANT i16 5
  ; CHECK-MC6809-NEXT:   [[PTR_ADD4:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C16]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C5]](s8), [[PTR_ADD4]](p0) :: (store (s8) into stack + 5)
  ; CHECK-MC6809-NEXT:   [[C17:%[0-9]+]]:_(s16) = G_CONSTANT i16 6
  ; CHECK-MC6809-NEXT:   [[PTR_ADD5:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C17]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C6]](s8), [[PTR_ADD5]](p0) :: (store (s8) into stack + 6)
  ; CHECK-MC6809-NEXT:   [[C18:%[0-9]+]]:_(s16) = G_CONSTANT i16 7
  ; CHECK-MC6809-NEXT:   [[PTR_ADD6:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C18]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C7]](s8), [[PTR_ADD6]](p0) :: (store (s8) into stack + 7)
  ; CHECK-MC6809-NEXT:   [[C19:%[0-9]+]]:_(s16) = G_CONSTANT i16 8
  ; CHECK-MC6809-NEXT:   [[PTR_ADD7:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C19]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C8]](s8), [[PTR_ADD7]](p0) :: (store (s8) into stack + 8)
  ; CHECK-MC6809-NEXT:   [[C20:%[0-9]+]]:_(s16) = G_CONSTANT i16 9
  ; CHECK-MC6809-NEXT:   [[PTR_ADD8:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C20]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C9]](s16), [[PTR_ADD8]](p0) :: (store (s16) into stack + 9, align 1)
  ; CHECK-MC6809-NEXT:   [[C21:%[0-9]+]]:_(s16) = G_CONSTANT i16 11
  ; CHECK-MC6809-NEXT:   [[PTR_ADD9:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C21]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C10]](s8), [[PTR_ADD9]](p0) :: (store (s8) into stack + 11)
  ; CHECK-MC6809-NEXT:   [[C22:%[0-9]+]]:_(s16) = G_CONSTANT i16 12
  ; CHECK-MC6809-NEXT:   [[PTR_ADD10:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C22]](s16)
  ; CHECK-MC6809-NEXT:   G_STORE [[C11]](s8), [[PTR_ADD10]](p0) :: (store (s8) into stack + 12)
  ; CHECK-MC6809-NEXT:   $ab = COPY [[C]](s8)
  ; CHECK-MC6809-NEXT:   BranchSubroutine @i8i16callee, mc6809_csr, implicit $ab, implicit-def $ad
  ; CHECK-MC6809-NEXT:   [[COPY1:%[0-9]+]]:_(s16) = COPY $ad
  ; CHECK-MC6809-NEXT:   ADJCALLSTACKUP 13, 0, implicit-def $ss, implicit $ss
  ...
  ; CHECK-HD6309-NEXT:   ADJCALLSTACKDOWN 13, 0, implicit-def $ss, implicit $ss
  ; CHECK-HD6309-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $ss
  ...
  ; CHECK-HD6309-NEXT:   G_STORE [[C4]](s16), [[PTR_ADD3]](p0) :: (store (s16) into stack + 3, align 1)
  ; CHECK-HD6309-NEXT:   [[C16:%[0-9]+]]:_(s16) = G_CONSTANT i16 5
  ; CHECK-HD6309-NEXT:   [[PTR_ADD4:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C16]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C5]](s8), [[PTR_ADD4]](p0) :: (store (s8) into stack + 5)
  ; CHECK-HD6309-NEXT:   [[C17:%[0-9]+]]:_(s16) = G_CONSTANT i16 6
  ; CHECK-HD6309-NEXT:   [[PTR_ADD5:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C17]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C6]](s8), [[PTR_ADD5]](p0) :: (store (s8) into stack + 6)
  ; CHECK-HD6309-NEXT:   [[C18:%[0-9]+]]:_(s16) = G_CONSTANT i16 7
  ; CHECK-HD6309-NEXT:   [[PTR_ADD6:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C18]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C7]](s8), [[PTR_ADD6]](p0) :: (store (s8) into stack + 7)
  ; CHECK-HD6309-NEXT:   [[C19:%[0-9]+]]:_(s16) = G_CONSTANT i16 8
  ; CHECK-HD6309-NEXT:   [[PTR_ADD7:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C19]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C8]](s8), [[PTR_ADD7]](p0) :: (store (s8) into stack + 8)
  ; CHECK-HD6309-NEXT:   [[C20:%[0-9]+]]:_(s16) = G_CONSTANT i16 9
  ; CHECK-HD6309-NEXT:   [[PTR_ADD8:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C20]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C9]](s16), [[PTR_ADD8]](p0) :: (store (s16) into stack + 9, align 1)
  ; CHECK-HD6309-NEXT:   [[C21:%[0-9]+]]:_(s16) = G_CONSTANT i16 11
  ; CHECK-HD6309-NEXT:   [[PTR_ADD9:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C21]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C10]](s8), [[PTR_ADD9]](p0) :: (store (s8) into stack + 11)
  ; CHECK-HD6309-NEXT:   [[C22:%[0-9]+]]:_(s16) = G_CONSTANT i16 12
  ; CHECK-HD6309-NEXT:   [[PTR_ADD10:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C22]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C11]](s8), [[PTR_ADD10]](p0) :: (store (s8) into stack + 12)
  ; CHECK-HD6309-NEXT:   $ab = COPY [[C]](s8)
  ; CHECK-HD6309-NEXT:   BranchSubroutine @i8i16callee, mc6809_csr, implicit $ab, implicit-def $ad
  ; CHECK-HD6309-NEXT:   [[COPY1:%[0-9]+]]:_(s16) = COPY $ad
  ; CHECK-HD6309-NEXT:   ADJCALLSTACKUP 13, 0, implicit-def $ss, implicit $ss
