...
; RUN: llc -O0 -stop-after=irtranslator -global-isel -global-isel-abort=1 -verify-machineinstrs %s -o - | FileCheck %s --check-prefixes=CHECK,CHECK-MC6809
; RUN: llc -mcpu hd6309 -O0 -stop-after=irtranslator -global-isel -global-isel-abort=1 -verify-machineinstrs %s -o - | FileCheck %s--check-prefixes=CHECK,CHECK-HD6309
...
define i8 @args_i8(i8 %x0, i8 %x1, i8 %x2, i8 %x3,
  ...
  ; CHECK-HD6309-NEXT: {{  $}}
  ; CHECK-HD6309-NEXT:   [[COPY:%[0-9]+]]:_(s8) = COPY $af
  ; CHECK-HD6309-NEXT:   [[COPY1:%[0-9]+]]:_(s8) = COPY $ae
  ; CHECK-HD6309-NEXT:   [[COPY2:%[0-9]+]]:_(s8) = COPY $ab
  ; CHECK-HD6309-NEXT:   [[COPY3:%[0-9]+]]:_(s8) = COPY $aa
  ...
  ; CHECK-HD6309-NEXT:   $af = COPY [[COPY]](s8)
  ; CHECK-HD6309-NEXT:   ReturnImplicit implicit $af
...
define i16 @args_i16(i16 %w0, i16 %w1, i16 %w2, i16 %w3,
  ...
  ; CHECK-HD6309-NEXT: {{  $}}
  ; CHECK-HD6309-NEXT:   [[COPY:%[0-9]+]]:_(s16) = COPY $aw
  ...
  ; CHECK-HD6309-NEXT:   $aw = COPY [[COPY]](s16)
  ; CHECK-HD6309-NEXT:   ReturnImplicit implicit $aw
...
define i8* @args_ptrs(i8* %x0, i16* %x1, <2 x i8>* %x2, {i8, i16, i16}* %x3,
  ...
  ; CHECK-HD6309-NEXT:   [[COPY2:%[0-9]+]]:_(p0) = COPY $aw
  ; CHECK-HD6309-NEXT:   [[COPY3:%[0-9]+]]:_(p0) = COPY $ad
  ; CHECK-HD6309-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.3
...
define void @test_stack_ext_needed() {
  ...
  ; CHECK-HD6309-NEXT:   CallRelative @stack_ext_needed, mc6809_csr, implicit $af, implicit $ae, implicit $ab, implicit $aa
...
define i8 @i8i16caller() nounwind readnone {
  ...
  ; CHECK-HD6309-NEXT:   $af = COPY [[C]](s8)
  ; CHECK-HD6309-NEXT:   $ae = COPY [[C1]](s8)
  ; CHECK-HD6309-NEXT:   $ab = COPY [[C2]](s8)
  ; CHECK-HD6309-NEXT:   $aa = COPY [[C3]](s8)
  ; CHECK-HD6309-NEXT:   $ix = COPY [[C4]](s16)
  ; CHECK-HD6309-NEXT:   $iy = COPY [[C9]](s16)
  ; CHECK-HD6309-NEXT:   CallRelative @i8i16callee, mc6809_csr, implicit $af, implicit $ae, implicit $ab, implicit $aa, implicit $ix, implicit $iy, implicit-def $aw
  ; CHECK-HD6309-NEXT:   [[COPY6:%[0-9]+]]:_(s16) = COPY $aw
  ; CHECK-HD6309-NEXT:   ADJCALLSTACKUP 6, -1, implicit-def $ss, implicit $ss
  ; CHECK-HD6309-NEXT:   [[TRUNC:%[0-9]+]]:_(s8) = G_TRUNC [[COPY6]](s16)
  ; CHECK-HD6309-NEXT:   $af = COPY [[TRUNC]](s8)
  ; CHECK-HD6309-NEXT:   ReturnImplicit implicit $af
entry:
