...
define void @test_varargs() {
  ...
  ; CHECK-MC6809-NEXT:   G_STORE [[C3]](s8), [[PTR_ADD4]](p0) :: (store (s8) into stack + 8)
  ; CHECK-MC6809-NEXT:   [[C13:%[0-9]+]]:_(s16) = G_CONSTANT i16 9
  ...
  ; CHECK-MC6809-NEXT:   [[C15:%[0-9]+]]:_(s16) = G_CONSTANT i16 15
  ...
  ; CHECK-MC6809-NEXT:   [[C16:%[0-9]+]]:_(s16) = G_CONSTANT i16 13
  ...
  ; CHECK-MC6809-NEXT:   [[C17:%[0-9]+]]:_(s16) = G_CONSTANT i16 23
  ...
  ; CHECK-MC6809-NEXT:   [[C18:%[0-9]+]]:_(s16) = G_CONSTANT i16 21
  ...
  ; CHECK-MC6809-NEXT:   [[C19:%[0-9]+]]:_(s16) = G_CONSTANT i16 19
  ...
  ; CHECK-HD6309-NEXT:   ADJCALLSTACKDOWN 22, 0, implicit-def $ss, implicit $ss
  ...
  ; CHECK-HD6309-NEXT:   G_STORE [[C2]](s8), [[PTR_ADD1]](p0) :: (store (s8) into stack + 4)
  ; CHECK-HD6309-NEXT:   [[C10:%[0-9]+]]:_(s16) = G_CONSTANT i16 5
  ...
  ; CHECK-HD6309-NEXT:   G_STORE [[C4]](s16), [[PTR_ADD3]](p0) :: (store (s16) into stack + 6, align 1)
  ; CHECK-HD6309-NEXT:   [[C12:%[0-9]+]]:_(s16) = G_CONSTANT i16 8
  ; CHECK-HD6309-NEXT:   [[PTR_ADD4:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C12]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C5]](s16), [[PTR_ADD4]](p0) :: (store (s16) into stack + 8, align 1)
  ; CHECK-HD6309-NEXT:   [[C13:%[0-9]+]]:_(s16) = G_CONSTANT i16 10
  ; CHECK-HD6309-NEXT:   [[PTR_ADD5:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C13]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[C6]](s32), [[PTR_ADD5]](p0) :: (store (s32) into stack + 10, align 1)
  ; CHECK-HD6309-NEXT:   [[UV2:%[0-9]+]]:_(s32), [[UV3:%[0-9]+]]:_(s32) = G_UNMERGE_VALUES [[C7]](s64)
  ; CHECK-HD6309-NEXT:   [[C14:%[0-9]+]]:_(s16) = G_CONSTANT i16 18
  ; CHECK-HD6309-NEXT:   [[PTR_ADD6:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C14]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[UV2]](s32), [[PTR_ADD6]](p0) :: (store (s32) into stack + 18, align 1)
  ; CHECK-HD6309-NEXT:   [[C15:%[0-9]+]]:_(s16) = G_CONSTANT i16 14
  ; CHECK-HD6309-NEXT:   [[PTR_ADD7:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C15]](s16)
  ; CHECK-HD6309-NEXT:   G_STORE [[UV3]](s32), [[PTR_ADD7]](p0) :: (store (s32) into stack + 14, align 1)
  ...
  ; CHECK-HD6309-NEXT:   ADJCALLSTACKUP 22, 0, implicit-def $ss, implicit $ss
