...
; O0-NEXT:    pshs u,y
; O0-NEXT:    tfr s,u
; O0-NEXT:    stx 18,u ; 2-byte Folded Spill
; O0-NEXT:    ldd 30,u
; O0-NEXT:    std 6,u
; O0-NEXT:    ldd 28,u
; O0-NEXT:    std 8,u
...
; O0-NEXT:    ldx 18,u ; 2-byte Folded Reload
; O0-NEXT:    ldd 12,u
; O0-NEXT:    std 2,x
; O0-NEXT:    ldd 10,u
; O0-NEXT:    std ,x
...
; O1-NEXT:    pshs u,y
; O1-NEXT:    tfr s,u
; O1-NEXT:    stx 18,u ; 2-byte Folded Spill
; O1-NEXT:    ldd 30,u
; O1-NEXT:    std 6,u
; O1-NEXT:    ldd 28,u
; O1-NEXT:    std 8,u
...
; O1-NEXT:    ldx 18,u ; 2-byte Folded Reload
; O1-NEXT:    ldd 12,u
; O1-NEXT:    std 2,x
; O1-NEXT:    ldd 10,u
; O1-NEXT:    std ,x
...
; O3-NEXT:    pshs u,y
; O3-NEXT:    tfr s,u
; O3-NEXT:    stx 18,u ; 2-byte Folded Spill
; O3-NEXT:    ldd 30,u
; O3-NEXT:    std 6,u
; O3-NEXT:    ldd 28,u
; O3-NEXT:    std 8,u
...
; O3-NEXT:    ldx 18,u ; 2-byte Folded Reload
; O3-NEXT:    ldd 12,u
; O3-NEXT:    std 2,x
; O3-NEXT:    ldd 10,u
; O3-NEXT:    std ,x
