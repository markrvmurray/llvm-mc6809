...
; MC6809-O0-NEXT:    ldb 15,u
; MC6809-O0-NEXT:    lda 14,u
; MC6809-O0-NEXT:    stb 5,u
; MC6809-O0-NEXT:    tfr a,b
; MC6809-O0-NEXT:    stb 15,u
...
; MC6809-O1-NEXT:    stb 7,u
; MC6809-O1-NEXT:    ldb 11,u
; MC6809-O1-NEXT:    lda 10,u
; MC6809-O1-NEXT:    stb 3,u
; MC6809-O1-NEXT:    tfr a,b
; MC6809-O1-NEXT:    stb 11,u
...
; MC6809-O2-NEXT:    stb 7,u
; MC6809-O2-NEXT:    ldb 11,u
; MC6809-O2-NEXT:    lda 10,u
; MC6809-O2-NEXT:    stb 3,u
; MC6809-O2-NEXT:    tfr a,b
; MC6809-O2-NEXT:    stb 11,u
...
; MC6809-O3-NEXT:    stb 7,u
; MC6809-O3-NEXT:    ldb 11,u
; MC6809-O3-NEXT:    lda 10,u
; MC6809-O3-NEXT:    stb 3,u
; MC6809-O3-NEXT:    tfr a,b
; MC6809-O3-NEXT:    stb 11,u
...
; HD6309-LABEL: loop:
; HD6309:       ; %bb.0: ; %entry
; HD6309-NEXT:    leas -14,s
; HD6309-NEXT:    pshs u
; HD6309-NEXT:    tfr s,u
; HD6309-NEXT:    stb 5,u
; HD6309-NEXT:    ldd #0
; HD6309-NEXT:    std 10,u
; HD6309-NEXT:    ldb 5,u
; HD6309-NEXT:    tstb
