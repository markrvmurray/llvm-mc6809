...
; MC6809-O0-NEXT:    clra
; MC6809-O0-NEXT:    std 15,u
; MC6809-O0-NEXT:    ldd 7,u
; MC6809-O0-NEXT:    ldd #0
; MC6809-O0-NEXT:    std 17,u
...
; MC6809-O0-NEXT:    stb 14,u
; MC6809-O0-NEXT:    tfr a,b
; MC6809-O0-NEXT:    stb 12,u
; MC6809-O0-NEXT:    ldb 18,u
; MC6809-O0-NEXT:    lda 17,u
; MC6809-O0-NEXT:    stb 6,u
; MC6809-O0-NEXT:    tfr a,b
; MC6809-O0-NEXT:    stb 18,u
; MC6809-O0-NEXT:    ldb 6,u
...
; MC6809-O0-NEXT:    ldb 16,u
; MC6809-O0-NEXT:    stb 14,u
; MC6809-O0-NEXT:    lda 15,u
; MC6809-O0-NEXT:    ldb 14,u
; MC6809-O0-NEXT:    ldb 14,u
...
; MC6809-O1-NEXT:    ldb 18,u
; MC6809-O1-NEXT:    lda 17,u
; MC6809-O1-NEXT:    stb 6,u
; MC6809-O1-NEXT:    tfr a,b
; MC6809-O1-NEXT:    stb 18,u
...
; MC6809-O1-NEXT:    ldb 16,u
; MC6809-O1-NEXT:    lda 15,u
...
; MC6809-O2-NEXT:    ldb 18,u
; MC6809-O2-NEXT:    lda 17,u
; MC6809-O2-NEXT:    stb 6,u
; MC6809-O2-NEXT:    tfr a,b
; MC6809-O2-NEXT:    stb 18,u
...
; MC6809-O2-NEXT:    ldb 16,u
; MC6809-O2-NEXT:    lda 15,u
...
; MC6809-O3-NEXT:    ldb 18,u
; MC6809-O3-NEXT:    lda 17,u
; MC6809-O3-NEXT:    stb 6,u
; MC6809-O3-NEXT:    tfr a,b
; MC6809-O3-NEXT:    stb 18,u
...
; MC6809-O3-NEXT:    ldb 16,u
; MC6809-O3-NEXT:    lda 15,u
...
; HD6309-NEXT:    ldb 18,u
; HD6309-NEXT:    lda 17,u
; HD6309-NEXT:    stb 6,u
; HD6309-NEXT:    tfr a,b
; HD6309-NEXT:    stb 18,u
; HD6309-NEXT:    ldb 6,u
; HD6309-NEXT:    pshs b
...
; HD6309-NEXT:    ldb 16,u
; HD6309-NEXT:    lda 15,u
; HD6309-NEXT:    addb #-1
; HD6309-NEXT:    adca #-1
; HD6309-NEXT:    std 2,u
; HD6309-NEXT:    std 15,u
