...
; MC6809-O1-NEXT:    ldb 15,u
; MC6809-O1-NEXT:    lda 14,u
; MC6809-O1-NEXT:    stb 5,u
; MC6809-O1-NEXT:    tfr a,b
; MC6809-O1-NEXT:    stb 15,u
...
; MC6809-O1-NEXT:    adcb 15,u
; MC6809-O1-NEXT:    stb 9,u
; MC6809-O1-NEXT:    tfr b,a
; MC6809-O1-NEXT:    sta 4,u
; MC6809-O1-NEXT:    ldb 11,u
; MC6809-O1-NEXT:    std 14,u
...
; MC6809-O2-NEXT:    ldb 15,u
; MC6809-O2-NEXT:    lda 14,u
; MC6809-O2-NEXT:    stb 5,u
; MC6809-O2-NEXT:    tfr a,b
; MC6809-O2-NEXT:    stb 15,u
...
; MC6809-O2-NEXT:    adcb 15,u
; MC6809-O2-NEXT:    stb 9,u
; MC6809-O2-NEXT:    tfr b,a
; MC6809-O2-NEXT:    sta 4,u
; MC6809-O2-NEXT:    ldb 11,u
; MC6809-O2-NEXT:    std 14,u
...
; MC6809-O3-NEXT:    ldb 15,u
; MC6809-O3-NEXT:    lda 14,u
; MC6809-O3-NEXT:    stb 5,u
; MC6809-O3-NEXT:    tfr a,b
; MC6809-O3-NEXT:    stb 15,u
...
; MC6809-O3-NEXT:    adcb 15,u
; MC6809-O3-NEXT:    stb 9,u
; MC6809-O3-NEXT:    tfr b,a
; MC6809-O3-NEXT:    sta 4,u
; MC6809-O3-NEXT:    ldb 11,u
; MC6809-O3-NEXT:    std 14,u
...
; HD6309-NEXT:    tfr a,b
; HD6309-NEXT:    stb 9,u
; HD6309-NEXT:    ldb 15,u
; HD6309-NEXT:    lda 14,u
; HD6309-NEXT:    stb 5,u
; HD6309-NEXT:    tfr a,b
; HD6309-NEXT:    stb 15,u
; HD6309-NEXT:    ldb 5,u
; HD6309-NEXT:    pshs b
