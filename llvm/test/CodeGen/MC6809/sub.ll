...
; O1-NEXT:    ldb 4,u
; O1-NEXT:    lda 10,u
; O1-NEXT:    stb <__scratch
; O1-NEXT:    sbca <__scratch
; O1-NEXT:    sta 10,u
; O1-NEXT:    lda 4,u
; O1-NEXT:    ldb 7,u
; O1-NEXT:    lda 10,u
...
; O2-NEXT:    ldb 4,u
; O2-NEXT:    lda 10,u
; O2-NEXT:    stb <__scratch
; O2-NEXT:    sbca <__scratch
; O2-NEXT:    sta 10,u
; O2-NEXT:    lda 4,u
; O2-NEXT:    ldb 7,u
; O2-NEXT:    lda 10,u
...
; O3-NEXT:    ldb 4,u
; O3-NEXT:    lda 10,u
; O3-NEXT:    stb <__scratch
; O3-NEXT:    sbca <__scratch
; O3-NEXT:    sta 10,u
; O3-NEXT:    lda 4,u
; O3-NEXT:    ldb 7,u
; O3-NEXT:    lda 10,u
