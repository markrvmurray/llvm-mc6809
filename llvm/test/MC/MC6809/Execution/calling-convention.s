...
;
; 8-bit calling convention validation.
;
; gcc6809 (the reference compiler) compiles harness-cc.c into a
; driver that calls the LLVM-compiled cc_funcs.ll directly. Both
...
; in X. The functions here take only i8 args so they exercise the
; i8 stack-slot path (1-byte slots, fixed by bug #69). If LLVM-MC6809
