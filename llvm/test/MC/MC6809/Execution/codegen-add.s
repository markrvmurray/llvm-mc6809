...
; RUN: %clang6809 -Oz -c -o %t-harness.o %S/Inputs/harness-add.c
...
; REQUIRES: usim
;
; Codegen execution test: 8-bit add functions. The harness
; (Inputs/harness-add.c) is compiled by gcc6809 and the functions
; under test (Inputs/codegen-add.ll) by LLVM-MC6809.
