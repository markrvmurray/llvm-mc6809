...
; RUN: %gcc6809 -S -Os -o %t-harness-raw.s %S/Inputs/harness-bitwise32.c
...
;
; Codegen execution test: 32-bit bitwise AND, OR, XOR. The harness
; (Inputs/harness-bitwise32.c) is compiled by gcc6809 and the
; functions under test (Inputs/codegen-bitwise32.ll) by LLVM-MC6809.
; The i32-returning functions are called via void-returning
; out-pointer wrappers (test_*32_w) defined in the .ll, because
; gcc6809 and LLVM-MC6809 use incompatible long-return conventions.
