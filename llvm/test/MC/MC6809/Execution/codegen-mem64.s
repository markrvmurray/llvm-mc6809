...
; RUN:   %S/Inputs/codegen-mem64.ll -o %t-raw.s 2>/dev/null
; RUN: grep -v '\.directpage' %t-raw.s > %t-funcs.s
; RUN: %clang6809 -Oz -c -o %t-harness.o %S/Inputs/harness-mem64.c
...
; RUN: %usim09batch --timeout=2000000 %t.hex | FileCheck %s
;
; i64 load/store round-trip across stack / global / struct-field /
; variable-index array shapes. Three patterns × four shapes = 12
; lines of identity output.
;
