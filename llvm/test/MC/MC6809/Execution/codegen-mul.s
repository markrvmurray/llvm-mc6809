...
; RUN: %gcc6809 -S -Os -o %t-harness-raw.s %S/Inputs/harness-mul.c
...
;
; Codegen execution test: 8-bit multiply functions. The harness
; (Inputs/harness-mul.c) is compiled by gcc6809 and the functions
; under test (Inputs/codegen-mul.ll) by LLVM-MC6809.
