...
; RUN: %clang6809 -Oz -c -o %t-harness.o %S/Inputs/harness-ptr.c
...
; REQUIRES: usim
;
; Codegen execution test: pointer dereference, array indexing, struct
; field access. The harness (Inputs/harness-ptr.c) is compiled by
; gcc6809 and the functions under test (Inputs/codegen-ptr.ll) by
; LLVM-MC6809; linking the two validates the pointer ABI plus the
; pointer/array codegen at every opt level.
