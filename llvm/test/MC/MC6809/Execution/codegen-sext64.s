...
; RUN:   %S/Inputs/codegen-sext64.ll -o %t-raw.s 2>/dev/null
; RUN: grep -v '\.directpage' %t-raw.s > %t-funcs.s
; RUN: %clang6809 -Oz -c -o %t-harness.o %S/Inputs/harness-sext64.c
...
; RUN: %usim09batch --timeout=2000000 %t.hex | FileCheck %s
;
; sext / zext to i64 execution test. Six sext rows (positive +
; negative for i8/i16/i32) followed by three zext sanity rows.
;
