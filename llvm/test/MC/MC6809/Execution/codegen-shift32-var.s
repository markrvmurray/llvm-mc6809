...
; RUN: %gcc6809 -S -Os -o %t-harness-raw.s %S/Inputs/harness-shift32-var.c
...
;
; Codegen execution test: i32 variable shift compiled from LLVM IR
; (which lowers internally to the __ashlsi3 libcall). The harness
; (Inputs/harness-shift32-var.c) is compiled by gcc6809 and the
; function under test (Inputs/codegen-shift32-var.ll) by LLVM-MC6809.
; The i32-returning shl32 is called via a void-returning out-pointer
; wrapper (shl32_w) defined in the .ll, because gcc6809 and
