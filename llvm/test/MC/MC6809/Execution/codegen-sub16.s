...
; RUN: %gcc6809 -S -Os -o %t-harness-raw.s %S/Inputs/harness-sub16.c
...
;
; Codegen execution test: 16-bit subtract functions. The harness
; (Inputs/harness-sub16.c) is compiled by gcc6809 and the
; functions under test (Inputs/codegen-sub16.ll) by LLVM-MC6809.
