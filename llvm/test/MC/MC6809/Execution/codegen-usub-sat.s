...
; RUN:   %S/Inputs/codegen-usub-sat.ll -o %t-raw.s 2>/dev/null
; RUN: grep -v '\.directpage' %t-raw.s > %t-funcs.s
; RUN: %clang6809 -Oz -c -o %t-harness.o %S/Inputs/harness-usub-sat.c
...
; REQUIRES: usim
;
; Codegen execution test for llvm.usub.sat (bug #115). Validates
; that unsigned saturating subtract returns the correct value at
; the no-underflow / boundary / underflow cases for both i8 and i16.
